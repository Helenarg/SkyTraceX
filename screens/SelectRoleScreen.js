...
//     switch (selectedRole) {
//       case "General":
//         navigation.navigate("screens/SubRoleScreen", { role: selectedRole, language });
//         break;
//       case "Farmer":
//         navigation.navigate("screens/roles/Farmer", { role: selectedRole, language });
//         break;
//       case "Fisherman":
//         navigation.navigate("screens/roles/Fisherman", { role: selectedRole, language });
//         break;
//       default:
//         navigation.navigate("Home", { role: selectedRole, language });
//     }
...
export default function SelectRoleScreen() {
  ...
  const roles = [
    { id: "Farmer", title: "Farmer / ගොවියා / விவசாயி", desc: "Weather insights for crop planning and agriculture", icon: "🌱" },
    { id: "Fisherman", title: "Fisherman / මාළුව / மீனவர்", desc: "Sea conditions and safety alerts for fishing", icon: "🌊" },
    { id: "General", title: "General User / සාමාන්‍ය පරිශීලක / பொதுப் பயனர்", desc: "Weather and astronomy for everyday life", icon: "☁️" },
  ];
        ...
        >
          {roles.map((role) => (
            ...
            >
              ...
              <Text style={styles.cardTitle}>{role.title}</Text>
              <Text style={styles.cardDesc}>{role.desc}</Text>
              {selectedRole === role.id && <Text style={styles.selectedLabel}>Selected</Text>}
            </TouchableOpacity>
          ))}
        </ScrollView>
...
const styles = StyleSheet.create({
  container: { flex: 1, alignItems: "center", justifyContent: "flex-start", paddingHorizontal: width * 0.05, paddingTop: Platform.OS === "web" ? 40 : height * 0.05 },
  contentWrapper: { width: "100%", maxWidth: 800, alignSelf: "center" },
  topBar: { width: "100%", flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: Platform.OS === "web" ? 25 : height * 0.03 },
  logoText: { fontSize: width * 0.06, fontWeight: "bold", color: "white" },
  languageSwitch: { flexDirection: "row", backgroundColor: "#1E293B", borderRadius: 10, overflow: "hidden" },
  langBtn: { paddingVertical: 5, paddingHorizontal: 12 },
  langBtnSelected: { backgroundColor: "#06B6D4" },
  langText: { color: "#94A3B8", fontWeight: "600" },
  langTextSelected: { color: "white" },
  title: { fontSize: width * 0.065, fontWeight: "bold", color: "white", textAlign: "center", marginBottom: Platform.OS === "web" ? 12 : height * 0.01 },
  subtitle: { fontSize: width * 0.035, color: "#CBD5E1", textAlign: "center", marginBottom: Platform.OS === "web" ? 30 : height * 0.03 },
  card: { backgroundColor: "#1E293B", paddingVertical: 20, paddingHorizontal: 15, borderRadius: 15, marginBottom: Platform.OS === "web" ? 20 : 15, alignItems: "center", width: "100%" },
  cardSelected: { borderWidth: 2, borderColor: "#06B6D4" },
  icon: { fontSize: width * 0.08, marginBottom: 8 },
  cardTitle: { fontSize: width * 0.045, fontWeight: "bold", color: "white", textAlign: "center", marginBottom: 6 },
  cardDesc: { fontSize: width * 0.033, color: "#94A3B8", textAlign: "center", marginBottom: 8 },
  selectedLabel: { fontSize: width * 0.032, color: "#06B6D4", fontWeight: "600" },
  button: { width: "100%", marginTop: Platform.OS === "web" ? 20 : height * 0.02, marginBottom: Platform.OS === "web" ? 30 : height * 0.03 },
  gradientBtn: { borderRadius: 12, paddingVertical: 14, alignItems: "center" },
